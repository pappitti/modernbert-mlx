...
🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨🚨  
ModernBERT-MLX is no longer maintained and has been superseded by [mlx-raclate](https://github.com/pappitti/mlx-raclate)(**R**etrieval **A**nd **C**lassification including **LATE** interaction). 
